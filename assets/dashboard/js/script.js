...
const side_bar_twenty_two_list = document.querySelector(
...
const side_bar_fourteen_list = document.querySelector(
  ".side_bar_fourteen_list"
);
const side_bar_first_list_twenty_four = document.querySelector(
  ".side_bar_first_list_twenty_four"
);
const side_bar_first_list_twenty_five = document.querySelector(
  ".side_bar_first_list_twenty_five"
);
const side_bar_twenty_six_list = document.querySelector(
  ".side_bar_twenty_six_list"
);
...
const first_twenty_two_child = document.querySelector(
  ".first_twenty_two_child"
);
...
const first_first_child_twenty_four = document.querySelector(
  ".first_first_child_twenty_four"
);
const first_first_child_twenty_five = document.querySelector(
  ".first_first_child_twenty_five"
);
const first_twenty_six_child = document.querySelector(
  ".first_twenty_six_child"
);
...
if (side_bar_first_list_twenty_four) {
  side_bar_first_list_twenty_four.addEventListener("click", () => {
    first_first_child_twenty_four.classList.toggle(
      "first_first_menu_twenty_four"
    );
    icon24.classList.toggle("rotate180");
  });
}

if (side_bar_first_list_twenty_five) {
  side_bar_first_list_twenty_five.addEventListener("click", () => {
    first_first_child_twenty_five.classList.toggle(
      "first_first_menu_twenty_five"
    );
    icon25.classList.toggle("rotate180");
  });
}

if (side_bar_twenty_six_list) {
