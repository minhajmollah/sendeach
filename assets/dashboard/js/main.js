...
const side_bar_twenty_three_list = document.querySelector(
  ".side_bar_twenty_three_list"
);
const side_bar_twenty_four_list = document.querySelector(
  ".side_bar_twenty_four_list"
);
const side_bar_twenty_five_list = document.querySelector(
  ".side_bar_twenty_five_list"
);
...
const first_twenty_three_child = document.querySelector(
  ".first_twenty_three_child"
);
const first_twenty_four_child = document.querySelector(
  ".first_twenty_four_child"
);
const first_twenty_five_child = document.querySelector(
    ".first_twenty_five_child"
);
...
if (side_bar_twenty_four_list) {
  side_bar_twenty_four_list.addEventListener("click", () => {
    first_twenty_four_child.classList.toggle("first_twenty_four_menu");
    icon24.classList.toggle("rotate180");
  });
}

if (side_bar_twenty_five_list) {
  side_bar_twenty_five_list.addEventListener("click", () => {
    first_twenty_five_child.classList.toggle("first_first_menu_twenty_five");
