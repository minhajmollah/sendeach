            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form
                                action="{{ route('user.email.contact.index') }}"
                                method="GET">
                                <div class="row align-items-center">
                                    <div class="col-lg-5">
                                        <input type="text" autocomplete="off" name="search"
                                               placeholder="{{ translate('Search with Email, Name') }}"
                                ...
                                <div class="col-12 col-md-8 col-lg-8 col-xl-7">
                                    <div class="row justify-content-end">
                                        <div class="col-12 col-md-4 col-lg-4 col-xl-3 py-1">
                                            <button
                                                class="btn--primary text--light border-0 w-100 px-1 py-2 rounded ms-2"
                                        ...
                                        <div class="col-12 col-md-4 col-lg-4 col-xl-3 py-1">
                                            @if(@$group)
                                                <a href="{{route('user.email.contact.group.export', $group->id)}}"
                                            ...
                                            @else
                                                <a href="{{route('user.email.contact.export')}}"
                                                   class="w-100 d-block btn--warning text--light border-0 px-1 py-2 rounded ms-2"><i
                                                        class="las la-cloud-download-alt"></i> {{ translate('Export Contact')}}
                                                </a>
                                            @endif
                ...
                <form action="{{route('user.email.contact.store')}}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="email" class="form-label">{{ translate('Email')}} <sup
                                ...
                                <div class="mb-3">
                                    <label for="email_group_id" class="form-label">{{ translate('Group')}} <sup
                                            class="text--danger">*</sup></label>
                                    <select class="form-select" name="email_group_id" id="email_group_id" required>
                                        <option value="">{{ translate('Select Group')}}</option>
                                        @foreach($user->emailGroup()->whereNot('type', \App\Models\Group::TYPE_SYSTEM)->get() as $group)
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">{{ translate('Download file format from here')}} <a
                                            href="{{route('email.contact.demo.import')}}">{{ translate('xlsx')}}</a>
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <label for="email_column"
                                           class="form-label">{{ translate('Email Column Name (Optional)')}}</label>
                                    <div
                                        class="form-text">{{ translate('If the Excel sheet includes multiple columns with email addresses, please indicate the specific column name that should be considered for importing.')}}</div>
                                    <input type="text" placeholder="Email Column Name" name="email_column"
                                           id="email_column" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
