                    ...
                    <ul>
                        ...
                        <li class="drop-down">
                            ...
                            <ul class="dropdown-menu drop_down_width" aria-labelledby="dropdownMenuButton1">
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{route('user.password')}}"><i class="me-1 las la-key"></i>@lang('Password Update')</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{route('user.sanctum-token.index')}}"><i class="me-1 las la-code"></i>@lang('API Tokens')</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{route('user.transaction.history')}}"><i class="me-1 las la-credit-card"></i>@lang('Transaction Logs')</a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                       href="{{ route('user.plan.subscription') }}"><i
                                            class="las la-paper-plane me-1"></i></span>{{ translate('Credits Log') }}</a>
                                </li>
                                <li>
