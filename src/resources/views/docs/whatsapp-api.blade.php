...
<ul class="section-items list-unstyled nav flex-column pb-3">
    <li class="nav-item section-title"><a class="nav-link scrollto active" href="#section-1"><span
                class="theme-icon-holder me-2"><i class="fa-brands fa-whatsapp"></i></span>Whatsapp API</a>
    </li>
...
<article class="docs-article" id="section-1">
    <header class="docs-header">
        <h1 class="docs-heading">WhatsApp API <span class="docs-time">Last updated: 2023-02-17</span>
        </h1>
        <section class="docs-intro">
            <div class="alert alert-warning mt-2">
                <p>The SendEach WhatsApp API should only be used for transactional purposes or in OTP applications.</p>
            </div>
    ...
    <section class="docs-section" id="item-1-1">
        ...
        <div class="mt-3 mb-5">
            <p class="h5">1. Generate an API POST request to the following url: https://sendeach.com/api/whatsapp/send</p>
            ...
            <img src="/assets/docs/images/doc-pages/whatsapp-api-url-and-auth-token.jpg" alt="login" class="img-fluid mt-2 border">
        </div>
        <div class=" mb-5">
        ...
        <div class=" mb-5">
            ...
            <ul>
                <li>Number is the attribute that you want to send the WhatsApp message to.</li>
                <li>Message is the content of your WhatsApp message.</li>
                <li>Schedule has two possible options [1, 2].</li>
                <li>Setting schedule to 1 will immediately send your WhatsApp message.</li>
        ...
        <div class="">
            ...
            <img src="/assets/docs/images/doc-pages/whatsapp-api-response.jpg" alt="login" class="img-fluid mt-2 border">
        </div>
        <!--//docs-code-block-->
    </section>
    <!--//section-->
