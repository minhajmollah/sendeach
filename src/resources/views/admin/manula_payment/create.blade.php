		...
		<div class="row d-flex align--center rounded">
			<div class="col-xl-12">
				<div class="table_heading d-flex align--center justify--between">
                    <nav  aria-label="breadcrumb">
					  	<ol class="breadcrumb">
					    	...
					    	<li class="breadcrumb-item" aria-current="page"> {{__($title)}}</li>
					  	</ol>
					</nav>
				...
				<div class="card">
					...
					<div class="card-body">
						<form action="{{route('admin.manual.payment.store')}}" method="POST" enctype="multipart/form-data">
							@csrf
							<div class="shadow-lg p-3 mb-5 bg-body rounded">
								<div class="row">
									...
									<div class="mb-3 col-lg-6 col-md-12">
										...
										<input type="text" name="name" id="name" class="form-control" placeholder=" {{ translate('Enter Name')}}" required="">
									</div>

									<div class="mb-3 col-lg-6 col-md-12">
										<label for="search_min" class="form-label"> {{ translate('Percent Charge')}} <sup class="text--danger">*</sup></label>
										<div class="input-group">
										  	<input type="text" class="form-control" id="percent_charge" name="percent_charge"  placeholder=" {{ translate('Enter Number')}}" aria-describedby="basic-addon2">
									...
									<div class="mb-3 col-lg-6 col-md-12">
										...
										<select class="form-select" name="currency_id" id="currency_id" required>
											...
											@foreach($currencies as $currency)
												<option value="{{$currency->id}}" data-rate_value="{{shortAmount($currency->rate)}}">{{__($currency->name)}}</option>
											@endforeach
										</select>
									</div>
									...
									<div class="mb-3 col-lg-6 col-md-12">
										...
										<div class="input-group mb-3">
										  	...
										  	<input type="text" name="rate" class="method-rate form-control" aria-label="Amount (to the nearest dollar)">
								...
								<div class="shadow-lg p-3 mb-5 bg-body rounded">
									...
									<div class="row my-3">
										...
										<div class="col-lg-12">
											<textarea class="form-control" name="payment_info" placeholder=" {{ translate('Give payment gateway information')}}"></textarea>
										</div>
									</div>
								</div>
