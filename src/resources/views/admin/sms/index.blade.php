            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form
                                action="{{route('admin.sms.search',$scope ?? str_replace('admin.sms.', '', request()->route()->getName()))}}"
                                method="GET">
                ...
                <div class="d-flex justify-content-start gap-2">
                    ...
                    <button class="btn btn-danger d-none d-md-block smsdelete"
                            data-bs-toggle="tooltip"
                                ...
                                @forelse($smslogs as $smsLog)
                                    <tr class="@if($loop->even) table-light @endif">
                                        <td class="d-none d-md-flex align-items-center">
                                            <input class="form-check-input mt-0 me-2" type="checkbox" name="smslogid"
                                                   value="{{$smsLog->id}}"
                                                   aria-label="Checkbox for following text input">
                                            {{$loop->iteration}}
                                        </td>
                                        ...
                                        <td data-label="{{ translate('Sender')}}">
                                            @if($smsLog->api_gateway_id)
                                                {{ translate('Api Gateway')}} <i class="las la-arrow-right"></i> <span
                                                    class="text--success fw-bold">{{ucfirst($smsLog->smsGateway->name)}}</span>
                                            @else
                                                {{ translate('Android Gateway')}}
                                                @if(@$smsLog->androidGateway->sim_number!="")
                                                    <i class="las la-arrow-right"></i> <span
                                                        class="text--violet fw-bold">
                    ...
                    <div class="modal-body">
                        <div class="card">
                            <div class="card-header bg--lite--violet">
                                <div
                                    class="card-title text-center text--light">{{ translate('SMS Status Update')}}</div>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
