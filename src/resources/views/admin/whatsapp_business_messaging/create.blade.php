    ...
    <section class="mt-3 rounded_box">
        <div class="container-fluid p-0 mb-3 pb-2">
            <div class="row d-flex align--center rounded">
                <div class="col-xl-12">
                    <div class="col-xl">
                        <form action="{{ route('admin.business.whatsapp.send') }}" method="POST"
    ...
    <script>
        (function ($) {
            ...
            $('select[name=template]').on('change', function () {
                ...
                $.ajax({
                    url: '{{route('admin.business.whatsapp.template.getTemplate', 'templateID')}}'.replace('templateID', templateID),
                    dataType: "json",
                    type: "get",
                    async: true,
                    data: {},
            ...
            function renderTemplate(template) {
                ...
                components.forEach((component) => {
                    ...
                    if (component.example) {
                        ...
                        component.example.body_text[0].forEach((parameter, i) => {
