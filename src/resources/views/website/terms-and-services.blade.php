...
@section('content')
<!-- ======= Hero Section ======= -->
<section id="hero" class="small-hero d-flex align-items-center">
    <div class="container">
        <div class="row gy-4">
...
<main id="main" class="bg-light">
    <section class="container mt-5">
        <p>Welcome to sendeach.com!</p>

        <p>These terms and conditions outline the rules and regulations for the use of SendEach's Website, located at
            https://sendeach.com/.</p>
        ...
        <p>We employ the use of cookies. By accessing sendeach.com, you agreed to use cookies in agreement with the
            SendEach's Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, SendEach and/or its licensors own the intellectual property rights for all material
            on
            sendeach.com. All intellectual property rights are reserved. You may access this from sendeach.com for your
            own
            personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from sendeach.com</li>
            <li>Sell, rent or sub-license material from sendeach.com</li>
            <li>Reproduce, duplicate or copy material from sendeach.com</li>
            <li>Redistribute content from sendeach.com</li>
        </ul>
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. SendEach does not filter, edit, publish or review Comments prior to their presence on
            the
            website. Comments do not reflect the views and opinions of SendEach,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
            applicable laws, SendEach shall not be liable for the Comments or for any liability, damages or expenses
            caused
            and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
            website.
        </p>

        <p>SendEach reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant SendEach a non-exclusive license to use, reproduce, edit and authorize others to use,
            reproduce
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you
            must inform us by sending an e-mail to SendEach. Please include your name, your organization name, contact
        ...
        <p>No use of SendEach's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
