...
INSERT INTO `admins` (`id`, `name`, `username`, `email`, `image`, `password`, `created_at`, `updated_at`) VALUES
(1, 'admin', 'admin', 'demo@example.com', NULL, '$2y$10$izQP6xySqec7PXn03fxHCeX8gK2K.xHDJ3THTGcIPytSziP4fIHWa', NULL, '2022-10-15 05:17:07');
...
CREATE TABLE `general_settings` (
  ...
  `s_login_google_info` text COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `general_settings` (`id`, `site_name`, `phone`, `country_code`, `sms_gateway`, `currency_name`, `currency_symbol`, `sms_gateway_id`, `email_gateway_id`, `mail_from`, `email_template`, `s_login_google_info`, `frontend_section`, `registration_status`, `cron_job_run`, `plan_id`, `sign_up_bonus`, `debug_mode`, `maintenance_mode`, `maintenance_mode_message`, `schedule_at`, `whatsapp_word_count`, `sms_word_text_count`, `sms_word_unicode_count`, `created_at`, `updated_at`) VALUES
(2, 'Company Name', '352345234', '1', 1, 'USD', '$', 2, 1, 'support@igensolutionsltd.com', '<p>{{message}}</p>', '{\"g_client_id\":\"#\",\"g_client_secret\":\"#\"}', '{\"heading\":\"Over 1K people using this app. Smooth SMS and Email Marketing tools\",\"sub_heading\":\"Our mass SMS and Email service provide you to reach more client engage, and also you can fill your target with the potential customer on the basis of different types of products and services which is you want to reach your client door. So why late if no account, sign up quickly and get your expect to plan and start from today with the best and cheap SMS cost!\"}', 1, '2022-12-12 18:19:39', 8, 2, 'false', 'false', 'Please be advised that there will be scheduled downtime across our network from 12.00AM to 2.00AM', NULL, 320, 160, 70, '2022-04-13 18:18:21', '2022-12-17 01:08:33');
...
(1, 'SMTP', 1, '{\"driver\":\"SMTP\",\"host\":\"\",\"smtp_port\":\"\",\"from\":{\"address\":\"\",\"name\":\"\"},\"encryption\":\"\",\"username\":\"\",\"password\":\"\"}', '2022-09-09 14:52:30', '2022-12-17 01:08:33'),
...
(2, '102TWI', 'twilio', '{\"account_sid\":\"@\",\"auth_token\":\"@\",\"from_number\":\"@\",\"sender_id\":\"@\"}', 1, '2022-09-09 20:33:40', '2022-09-17 18:42:28'),
...
(6, '106INFOBIP', 'InfoBip', '{\"infobip_base_url\":\"#\",\"infobip_api_key\":\"#\",\"sender_id\":\"#\"}', 1, '2022-09-09 20:20:14', '2022-09-17 18:43:45'),
...
CREATE TABLE `wa_device` (
  ...
  `description` varchar(259) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `multidevice` enum('YES','NO') COLLATE utf8mb4_unicode_ci NOT NULL,
